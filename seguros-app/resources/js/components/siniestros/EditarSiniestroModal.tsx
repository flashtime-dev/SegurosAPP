                        ...
                        <div className="grid gap-4">
                            ...
                            <div>
                                ...
                                >
                                    ...
                                    <SelectContent>
                                        {polizas.map((poliza) => (
                                            <SelectItem className="cursor-pointer hover:bg-gray-100" key={poliza.id} value={String(poliza.id)}>
                                                {poliza.numero}
                                            </SelectItem>
                                        ))}
                                    </SelectContent>
                            ...
                            <div className="space-y-4">
                                <div className="flex justify-between items-center">
                                    ...
                                    <Button className="cursor-pointer" type="button" variant="outline" onClick={agregarContacto}>
                                        Agregar Contacto
                                    </Button>
                                </div>
